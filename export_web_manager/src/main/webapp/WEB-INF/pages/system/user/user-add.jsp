        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="/system/user/edit.do" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <div class="form-group form-inline"  style="font-size: 3px">
                            <div class="radio"><label><input type="radio" <%--${user.degree==0?'checked':''}--%> name="degree" value="0">saas管理</label></div>
                            <div class="radio"><label><input type="radio" <%--${user.degree==1?'checked':''}--%> name="degree" value="1">企业管理</label></div>
                            <div class="radio"><label><input type="radio" <%--${user.degree==2?'checked':''}--%> name="degree" value="2">管理下属部门</label></div>
